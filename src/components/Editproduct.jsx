...
const theme = createTheme({
  direction: "rtl",
  palette: {mode: "light", // אפשר גם "dark"
  },});
// Cache עם RTL
...
function EditModal({ open, onClose, meal,setMeals }) {
    ...
    return (
      ...
      <form onSubmit={handleSubmit(onSubmit)} style={{border: "1px solid white",width: 550,height: 600,
            display: "flex",flexDirection: "column",
            backgroundColor: "rgb(0, 0, 0)", direction: "rtl",
            borderRadius: 2,boxShadow: "0 4px 8px rgba(255, 255, 255, 0.068), 0 0px 7px",margin:"50px 500px 0px 0px"}}>
...
<Box sx={{ mb: 2}}>
      ...
      <ThemeProvider theme={theme}>
        <div dir="rtl" style={{ width: 450, margin: "8px 50px 0px 0px" }}>
        <Box sx={{ mb: 2}}>
                <TextField fullWidth label="תמונת המוצר" type="text" error={!!errors.mealImage}
        ...
        {/* כפתור שליחה */}
        <Button type="submit" fullWidth sx={{width: 450,margin:"30px 50px 0px 0px", height: 50,fontSize: 20,backgroundColor: "rgb(240 202 124)",color: "white",
          }}variant="contained">
          עריכת המוצר
        </Button>
            </form>
